    ...
    <nav className="text-white w-full fixed top-0 z-50" style={{ backgroundColor: '#0b6385' }}>
      ...
      {showMenu && (
        <div className="md:hidden text-center bg-gray-800 py-4">
          <Link to='hero' className='block py-2 text-white hover:text-purple-500 transition duration-200' smooth={true}>Home</Link>
          ...
          <a href="mailto:javierjimenemk@gmail.com" className="block py-2 text-white hover:text-purple-500 transition duration-200" target="_blank">Contact</a>
        </div>
      )}
    </nav>
  );
